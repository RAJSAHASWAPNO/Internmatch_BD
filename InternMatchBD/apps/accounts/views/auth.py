...
from account.forms import EmployerRegistrationForm, StudentRegistrationForm, UserLoginForm
...
class StudentRegistrationView(CreateView):
    """Handles student (job seeker) registration."""
    form_class = StudentRegistrationForm
    template_name = 'account/student-registration.html'
